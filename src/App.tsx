...
(async () => {
  try {
    ...
    await supabase.rpc('enable_realtime', { table_name: 'messages' } as unknown as Record<string, never>);
    await supabase.rpc('enable_realtime', { table_name: 'notifications' } as unknown as Record<string, never>);
    await supabase.rpc('enable_realtime', { table_name: 'reviews' } as unknown as Record<string, never>);
